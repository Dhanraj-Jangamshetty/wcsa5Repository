...
public class WorkLib extends BaseTest  {
	...
	public void hanldeFrameByusingFrameElement(WebElement  FrameEle) {
		driver.switchTo().frame(FrameEle);	
	}
	public void swichTomainPage() {
		driver.switchTo().defaultContent();
	}
	public void swichToParentPage() {
		driver.switchTo().parentFrame();
	}
	//handle the mouse Action
	public void mouseHaverMethod(WebElement target) 
	{
